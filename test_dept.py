...
# Test department import
print("=== 04_training_coe.xlsx (as department) ===")
try:
    val, commit = upload_and_process(r"C:\Users\asada\Desktop\coe_mixed_test_data_100plus\04_training_coe.xlsx", "department")

...
import { Eye, EyeOff, Lock, User, Shield, AlertCircle, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-white/95 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 sm:p-10 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between text-xs pt-1">
            ...
            <span className="text-slate-400 text-[11px]">Default: admin / admin123</span>
          </div>
